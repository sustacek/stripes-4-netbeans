...
/**
 * This filter accepts all files representing Stripes Action Bean Context class. 
 * 
 * TODO
 * 
 * @author Josef Sustacek
 */
public class ActionBeanContextsFilter implements FileFilter{

    public ActionBeanContextsFilter() {
    }
